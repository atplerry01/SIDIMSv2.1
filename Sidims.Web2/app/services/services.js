(function () {
    ...
    app.service('$menuItems', function (authService, localStorageService) {
        ...
        this.createClientMenu = function () {
            ...
            var jobs = this.addItem('Jobs', '/', 'fa fa-check-circle-o fa-fw');
            var inventory = this.addItem('Inventory', '/', 'fa fa-tasks fa-fw');

            //// Subitems of Jobs
            jobs.addItem('Pending Jobs', '/pending-jobs', 'fa-angle-right');
            jobs.addItem('Completed Jobs', '/completed-jobs', 'fa-angle-right');

            inventory.addItem('MIS Reports', '/mis-reports', 'fa-angle-right');
        }
