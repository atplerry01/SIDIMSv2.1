(function () {
    'use strict';
    var controllerId = 'DeliveryNoteDetail';
    angular
        .module('app')
        .controller('DeliveryNoteDetail', DeliveryNoteDetail);

    DeliveryNoteDetail.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext'];

    function DeliveryNoteDetail($location, $routeParams, $scope, common, datacontext) {
