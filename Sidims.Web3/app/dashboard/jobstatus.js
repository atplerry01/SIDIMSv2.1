(function () {
    ...
    JobStatus.$inject = ['$location', '$route', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function JobStatus($location, $route, $routeParams, $scope, common, config, datacontext, model, resourceService) {
