    ...
    function RepositoryResourceJob($routeParams, common, authService, model, AbstractRepository) {
        ...
        function getJobs(forceRemote, page, size, nameFilter) {
            ...
            return EntityQuery.from('Jobs')
                .select('id, isDeleted, jobName, sidSectorId, sidClientId, sidCardTypeId, jobStatusId, remark, serviceTypeId, quantity, createdOn')
                .orderBy(orderBy)
        ...
        function getJobByTrackerId(val, forceRemote) {
            ...
            return EntityQuery.from('JobByTrackerId')
                .select('id, isDeleted, jobName, sidSectorId, sidClientId, sidCardTypeId, remark, serviceTypeId, quantity')
        ...
        function getJobTrackerByJobId(jobId, forceRemote) {
            ...
            return EntityQuery.from('JobTrackerByJobId')
                .select('id, isDeleted, jobId, cardOpsId, inventoryId, printingId, cardEngrId, qAId, firstJobRunId, cardEngrResumeId, qCId, mailingId, dispatchId, customerServiceId')
        ...
        function getIncompleteJobs(forceRemote) {
            ...
            return EntityQuery.from('IncompleteJobs')
                .select('id, isDeleted, jobName, sidSectorId, sidClientId, remark, serviceTypeId, quantity, jobStatusId')
                .orderBy(orderBy)
                .toType(entityNames.job)
                .using(self.manager).execute()
                .then(querySucceeded, self._queryFailed);
